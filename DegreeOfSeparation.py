...
class MRBFSIteration(MRJob):
    ...
    def reducer(self, key, values):
        ...
        # There's a bug in mrjob where sorting fails with too much data.
        # As a workaround. we're limiting the number of edges to 500 here.
        # You'd remove the [:500] if you were running this for real on
        # a linux cluster
